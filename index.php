...
<head>
	...
	<link rel="icon" href="img/po.png" type="image/png">
	<link rel="shortcut icon" href="img/po.png" type="img/x-icon">
	...
	<header class="header" id="header">
		...
		<div class="container">
			<figure class="logo animated fadeInDown delay-07s">
				<a href="#"><img src="po.png" alt=""></a>
			</figure><h><b><b>TALEGAON  POLICE</b></b></h>
			<h1 class="animated fadeInDown delay-07s">WELCOME TO TALEGAON TRAFFIC CONTROL</h1>
			<ul class="we-create animated fadeInUp delay-1s">
				<li><b>IF U BREAK THE RULE THEN PAY FINE</b></li>
			</ul>
	...
	<nav class="main-nav-outer" id="test">
		...
		<div class="container">
			<ul class="main-nav">
				...
				<li class="small-logo"><a href="#header"><img src="img/po.png" height="70" width="70" alt=""></a></li>
 ...
 <br></p>
	...
	<section class="main-section client-part" id="client">
		...
		<div class="container">
						<div class="row">
				<div class="col-lg-12">
					<h4 style="font-style: italic; color: white;"> This a Mini Project Of WT Guided By Prof.SNEHA BANKAR </h4>
				</div>
			</div>
            ...
            <li><a href="#">
            	<img src="img/amit.jpg" height="120" width="120" alt="">
                <h3>Amit Shinde</h3>
				<li><a href="#">
            				</ul>
		</div>
			...
			<div class="team-leader-block clearfix">
				<div class="team-leader-box">
					<div class="team-leader  wow fadeInDown delay-06s">
						...
						<img src="img/p3.jpg" width="300" height="300" alt="">
					</div>
					<h3 class="wow fadeInDown delay-06s">Bajirao singham</h3>
					<span class="wow fadeInDown delay-06s">Director General of Police</span>
				</div>
				<div class="team-leader-box">
					<div class="team-leader  wow fadeInDown delay-06s">
						<div class="team-leader-shadow"><a href="#"></a></div>
						<img src="img/p2.jpeg" width="300" height="300" alt="">
					</div>
					<h3 class="wow fadeInDown delay-06s">Sorya Singh</h3>
					<span class="wow fadeInDown delay-06s">Director General of Police</span>
				</div>
				<div class="team-leader-box">
					<div class="team-leader wow fadeInDown delay-09s">
						<div class="team-leader-shadow"><a href="#"></a></div>
						<img src="img/p1.jpg" width="300" height="300" alt="">
					</div>
					<h3 class="wow fadeInDown delay-09s">Rakesh Samant</h3>
			...
			<div class="row">
				<div class="col-lg-6 col-sm-7 wow fadeInLeft">
					<div class="contact-info-box address clearfix">
						...
						<span>Yashwant Nagar station, Talegaon</span>
					</div>
					<div class="contact-info-box phone clearfix">
						<h3><i class="fa fa-phone"></i>Phone:</h3>
						<span>9420728595</span>
					</div>
					<div class="contact-info-box email clearfix">
						<h3><i class="fa fa-pencil"></i>email:</h3>
						<span>amty29@gmail.com</span>
					</div>
