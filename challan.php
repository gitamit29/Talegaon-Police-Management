	...
	<header class="header" id="header">
		...
		<div class="container">
			<figure class="logo animated fadeInDown delay-07s">
				<a href="#"><img src="img/po.png" alt=""></a>
			</figure>
			<h2 style="color: white;"><b>TALEGAON  POLICE</b></h2>
...
<div class="form-group mt-3 d-flex justify-content-between align-items-center text-white">
  <label class="mb-0">Helmet Violation</label>
  <input type="checkbox" class="ctype" name="vname" value="7000" cname="Helmet Violation" />
</div>

<div class="form-group mt-3 d-flex justify-content-between align-items-center text-white">
  <label class="mb-0">Signal Jumping</label>
  <input type="checkbox" class="ctype" name="vname" value="8000" cname="Signal Jumping" />
</div>

<div class="form-group mt-3 d-flex justify-content-between align-items-center text-white">
  <label class="mb-0">Drunk Driving</label>
  <input type="checkbox" class="ctype" name="vname" value="2000" cname="Drunk Driving" />
</div>

<div class="form-group mt-3 d-flex justify-content-between align-items-center text-white">
  <label class="mb-0">Over Speeding</label>
  <input type="checkbox" class="ctype" name="vname" value="3500" cname="Over Speeding" />
</div>

<div class="form-group mt-3 d-flex justify-content-between align-items-center text-white">
  <label class="mb-0">No Parking</label>
  <input type="checkbox" class="ctype" name="vname" value="1500" cname="No Parking" />
</div>
			...
			<div class="row">
				<div class="col-lg-6 col-sm-7 wow fadeInLeft">
					<div class="contact-info-box address clearfix">
						...
						<span>Room-708,Ayush Park Phase-1,Talegaon</span>
					</div>
